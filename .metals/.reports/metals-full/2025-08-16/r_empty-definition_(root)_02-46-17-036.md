error id: file://<WORKSPACE>/src/main/scala/zeroHungerGame/core/SceneManager.scala:`<none>`.
file://<WORKSPACE>/src/main/scala/zeroHungerGame/core/SceneManager.scala
empty definition using pc, found symbol in pc: `<none>`.
semanticdb not found
empty definition using fallback
non-local guesses:
	 -scalafx/Includes.MenuController.
	 -scalafx/Includes.MenuController#
	 -scalafx/Includes.MenuController().
	 -zeroHungerGame/controllers/MenuController.
	 -zeroHungerGame/controllers/MenuController#
	 -zeroHungerGame/controllers/MenuController().
	 -MenuController.
	 -MenuController#
	 -MenuController().
	 -scala/Predef.MenuController.
	 -scala/Predef.MenuController#
	 -scala/Predef.MenuController().
offset: 403
uri: file://<WORKSPACE>/src/main/scala/zeroHungerGame/core/SceneManager.scala
text:
```scala
...
import zeroHungerGame.controllers.{Menu@@Controller, EducationController, ResultController}
