error id: file://<WORKSPACE>/src/main/scala/zeroHungerGame/game/GameEngine.scala:matchesFood.
file://<WORKSPACE>/src/main/scala/zeroHungerGame/game/GameEngine.scala
empty definition using pc, found symbol in pc: matchesFood.
empty definition using semanticdb
empty definition using fallback
non-local guesses:
	 -character/matchesFood.
	 -character/matchesFood#
	 -character/matchesFood().
	 -scala/Predef.character.matchesFood.
	 -scala/Predef.character.matchesFood#
	 -scala/Predef.character.matchesFood().
offset: 6040
...
class GameEngine(initialMode: String) {
      ...
      def matchFoodToCharacter(character: Character): Boolean = {
            ...
            _selectedFood.value match {                             
                  case Some(food) =>
                  if (character.matche@@sFood(food)) {
                  food.isMatched = true
