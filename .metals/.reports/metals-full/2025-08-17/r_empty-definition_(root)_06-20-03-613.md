error id: file://<WORKSPACE>/src/main/scala/zeroHungerGame/controller/MenuController.scala:setOnAction.
file://<WORKSPACE>/src/main/scala/zeroHungerGame/controller/MenuController.scala
empty definition using pc, found symbol in pc: setOnAction.
empty definition using semanticdb
empty definition using fallback
non-local guesses:
	 -scalafx/Includes.audioToggleButton.setOnAction.
	 -scalafx/Includes.audioToggleButton.setOnAction#
	 -scalafx/Includes.audioToggleButton.setOnAction().
	 -audioToggleButton/setOnAction.
	 -audioToggleButton/setOnAction#
	 -audioToggleButton/setOnAction().
	 -scala/Predef.audioToggleButton.setOnAction.
	 -scala/Predef.audioToggleButton.setOnAction#
	 -scala/Predef.audioToggleButton.setOnAction().
offset: 2562
