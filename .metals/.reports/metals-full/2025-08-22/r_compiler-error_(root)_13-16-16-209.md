...
parent      = new FoodItem("Fish", 180,
  Set("protein",
    "omega-),               " images / foods / fish _root_.scala.Predef.???)
) # -1,
parent span = <4284..6339>,
child       = Set("protein",
  "omega-),               " images / foods / fish _root_.scala.Predef.???) # -1,
child span  = [4316..4319..6352]
...
object FoodItem { 
      ...
      def create(foodType: String): FoodItem = {
            foodType.toLowerCase.replace(" ", "").replace("-", "") match {
                  ...
                  case "fish"       => new FoodItem("Fish",       180, Set("protein", "omega-),               "images/foods/fish.png")
