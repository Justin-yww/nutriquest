...
parent      = new FoodItem("Fish", 180,
  Set("protein",
    "om),               " images / foods / fish _root_.scala.Predef.???)
) # -1,
parent span = <4284..6335>,
child       = Set("protein",
  "om),               " images / foods / fish _root_.scala.Predef.???) # -1,
child span  = [4316..4319..6348]
...
object FoodItem { 
      ...
      def create(foodType: String): FoodItem = {
            foodType.toLowerCase.replace(" ", "").replace("-", "") match {
                  ...
                  case "fish"       => new FoodItem("Fish",       180, Set("protein", "om),               "images/foods/fish.png")
