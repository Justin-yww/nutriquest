...
parent      = new FoodItem("Fish", 180,
  Set("protein",
    "omeg),               " images / foods / fish _root_.scala.Predef.???)
) # -1,
parent span = <4284..6337>,
child       = Set("protein",
  "omeg),               " images / foods / fish _root_.scala.Predef.???) # -1,
child span  = [4316..4319..6350]
...
object FoodItem { 
      ...
      def create(foodType: String): FoodItem = {
            foodType.toLowerCase.replace(" ", "").replace("-", "") match {
                  ...
                  case "fish"       => new FoodItem("Fish",       180, Set("protein", "omeg),               "images/foods/fish.png")
